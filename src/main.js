...
moon = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({ 
        ...
        // emissive: new THREE.Color(0xD95D39 ),
        emissiveMap: moonTexture 
    })
);

// Posicionamiento
// La colocamos en un punto alto y lejano para que se vea durante el viaje del avión
moon.position.set(0, 120, -500); 

 scene.add(moon);
 water.material.uniforms['sunDirection'].value.copy(moon.position).normalize();    // const moonGeo = new THREE.SphereGeometry(10, 32, 32);
